...
let TasksController = class TasksController {
    ...
    getTasks(filterDto, user) {
        this.logger.verbose(`User ${user.email} retrieving all tasks. Filter ${JSON.stringify(filterDto)}`);
    ...
    createTask(createTaskDto, user) {
        this.logger.verbose(`User ${user.email} create a new task Data: ${JSON.stringify(createTaskDto)}`);
